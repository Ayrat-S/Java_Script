...
// СКРИПТ по 26-33 пунктам:
// P.S. Для вывода в OUTPUT сообщений к допуску по возрасту, введите в const age_1 следующий возраст: 10, 17, 18, 59, 60, 61.
...
console.table("Technical work")
console.error("Technical work")
console.warn("Technical work")
console.info("Technical work")
console.debug("Technical work")
